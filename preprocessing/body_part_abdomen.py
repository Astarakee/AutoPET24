...
write_path = '/home/mehdi/Data/AutoPET24/Dataset705_AutoPET24Crop_Abdomen'
...
for ix, case in enumerate(label_files):
    ...
    ax_ind_upper, _, _ = np.where(rib11_array==1)
    ...
    if min_ax_marginal_lower<0:
        min_ax_marginal_lower = 0
