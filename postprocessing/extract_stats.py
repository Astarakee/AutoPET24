...
def get_lesion_stats(data_path):
    ...
    write_pickle(pkl_name, dataset_stats)
    print('-'*3)
    print('datasets was saved as a pkl file!')

    return None
data_path = "/mnt/workspace/data/AutoPET_raw/"
if __name__ == '__main__':
    get_lesion_stats(data_path)
